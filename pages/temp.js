  ...
  return(
    <div id="index">
      <div className="titles">
        ...
        <div className="btn-connect" onClick={() => setConnectOpen(true)}>
            {userInfo?.status === "finish" ? t("index_title_btn_2") : t("index_title_btn_1")} 
            {/* <CaretRight /> */}
        </div>
      </div>
    <div className="blocks-1">
        <div className="block block-left">
            ...
            <a className="btn" href={t("index_block_1_block_1_btn_link")} target="_blank" rel="noopener noreferrer">{t("index_block_1_block_1_btn")}
            {/* <CaretRight /> */}
            </a>
            <div className="img">
        ...
        <div className="block-right">
            ...
            <div className="block block-right-2">
                ...
                <p>{t("index_block_1_block_3_last_update")}{dateTimeString()}</p>
            </div>
        </div>
    </div>
